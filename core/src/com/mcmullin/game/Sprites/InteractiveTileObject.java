 ...
 */
//COMMENTS- Can ignore this class
...
public abstract class InteractiveTileObject {
    ...
    public abstract void onHeadHit(Char myChar);
    ...
    public TiledMapTileLayer.Cell getCell(){
        ...
        return layer.getCell((int)(body.getPosition().x * MyGdxGame.PPM / 14),
                (int)(body.getPosition().y * MyGdxGame.PPM / 14));
    }
