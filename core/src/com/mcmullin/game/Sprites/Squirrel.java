...
public class Squirrel extends Enemy {
    ...
    protected void defineEnemy()
    {
        ...
        vertice[0] = new Vector2(-18,18).scl(1/MyGdxGame.PPM);
        vertice[1] = new Vector2(18,18).scl(1/MyGdxGame.PPM);
        vertice[2] = new Vector2(18,-18).scl(1/MyGdxGame.PPM);
        vertice[3] = new Vector2(-18,-18).scl(1/MyGdxGame.PPM);
        head.set(vertice);
        fdef.shape = head;
        //fdef.restitution = 1f;
